...
- `pq-web-src/main.js:666-726` defines `CompleteQuest`: reset bar, log/check prior quests, choose one of four rewards, cap history at 99, clear the target, generate one of five quest kinds, append/log the new quest, and save.
